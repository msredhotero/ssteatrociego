...
--
-- Servidor: localhost
-- Tiempo de generación: 23-05-2017 a las 16:39:51
...
CREATE TABLE IF NOT EXISTS `dbdomicilios` (
  ...
  `calle` varchar(220) COLLATE utf8_spanish_ci DEFAULT NULL,
...
(2, 'Sonido 360', 1, '100.00', 1, '150.00', '1.50', '6.05', '0.00', '10.00', '0.00', '2017-05-04', 'Saupurein Marcos', '0000-00-00', '', b'1');
...
CREATE TABLE IF NOT EXISTS `dbpromosobras` (
  ...
  `refobras` int(11) NOT NULL,
  `vignciadesde` date DEFAULT NULL,
