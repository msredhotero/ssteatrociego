...
--
-- Servidor: localhost
-- Tiempo de generación: 21-06-2017 a las 08:45:19
...
(1, 'Babilonia FX - Viernes', 16, 3, 13, '2017-05-05', 'Saupurein Marcos', '2017-05-05', 'Saupurein Marcos', b'1');
...
CREATE TABLE IF NOT EXISTS `dbgastosobras` (
  ...
  KEY `fk_gastos_obras_idx` (`refobras`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=4 ;

--
-- Volcado de datos para la tabla `dbgastosobras`
--

INSERT INTO `dbgastosobras` (`idgastoobra`, `refobras`, `descripcion`, `monto`, `fechacreacion`, `usuacrea`) VALUES
(1, 1, 'Lamparas', '450.00', '2017-06-21', 'Saupurein Marcos');
...
CREATE TABLE IF NOT EXISTS `dbpersonalcargos` (
  ...
  `refcooperativa` int(11) DEFAULT NULL,
...
INSERT INTO `dbventas` (`idventa`, `numero`, `reftipopago`, `fecha`, `total`, `cancelado`, `usuario`, `refcategorias`, `refpromosobras`, `refobras`, `refalbum`, `monto`, `porcentaje`, `valorentrada`, `observacion`, `fechacreacion`, `usuacrea`, `fechamodi`, `usuamodi`, `cantidad`) VALUES
(4, 'CC00000001', 2, '2017-06-20 00:00:00', '300.00', b'0', 'Saupurein Marcos', 0, 0, 2, 1, '0.00', '0.00', '100.00', '', '2017-06-20', 'Saupurein Marcos', '0000-00-00', '', 3);
...
--
-- Filtros para la tabla `dbgastosobras`
--
ALTER TABLE `dbgastosobras`
  ADD CONSTRAINT `fk_gastos_obras` FOREIGN KEY (`refobras`) REFERENCES `dbobras` (`idobra`) ON DELETE NO ACTION ON UPDATE NO ACTION;
