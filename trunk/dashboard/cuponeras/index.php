...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Cuponeras",$_SESSION['refroll_predio'],$_SESSION['sede']);
...
$eliminar = "eliminarCuponeras";

$insertar = "insertarCuponeras";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerCuponeras(),6);
