...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Salas",$_SESSION['refroll_predio'],$_SESSION['sede']);


$id = $_GET['id'];

$resResultado = $serviciosReferencias->traerSalasPorId($id);
...
$eliminar = "eliminarSalas";

$modificar = "modificarSalas";
...
$(document).ready(function(){
	...
	<?php
		$serviciosFunciones->jsBit('activa',mysql_result($resResultado,0,'activa'));
	?>
