...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Personal",$_SESSION['refroll_predio'],$_SESSION['sede']);


$id = $_GET['id'];

$resResultado = $serviciosReferencias->traerDomiciliosPorPersona($id);
...
$lblCambio	 	= array("refpersonal","codigopostal","telefonoparticular","telefonocelular");
$lblreemplazo	= array("Persona","Cod. Postal","Tel. Particular","Tel. Movil");
