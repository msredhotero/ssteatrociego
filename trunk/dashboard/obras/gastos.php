...
$resResultado = $serviciosReferencias->traerGastosobrasPorObra($id);
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerGastosobrasPorObra($id),2);
