...
$resMenu = $serviciosHTML->menu($_SESSION['nombre_predio'],"Funciones",$_SESSION['refroll_predio'],$_SESSION['sede']);
...
$cadRef2 	= 	$serviciosFunciones->devolverSelectBox($resCO,array(1),'');
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerFunciones(),90);
