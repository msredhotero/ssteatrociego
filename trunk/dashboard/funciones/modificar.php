...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Funciones",$_SESSION['refroll_predio'],$_SESSION['sede']);


$id = $_GET['id'];

$resResultado = $serviciosReferencias->traerFuncionesPorId($id);
...
$eliminar = "eliminarFunciones";

$modificar = "modificarFunciones";
...
$lblCambio	 	= array("refobras","refcooperativas","refdias");
$lblreemplazo	= array("Obras","Cooperativa","Dia");

$resObras	=	$serviciosReferencias->traerObras();
$cadRef 	= 	$serviciosFunciones->devolverSelectBoxActivo($resObras,array(1),'',mysql_result($resResultado,0,'refobras'));

$resCO	=	$serviciosReferencias->traerCooperativas();
$cadRef2 	= 	$serviciosFunciones->devolverSelectBoxActivo($resCO,array(1),'',mysql_result($resResultado,0,'refcooperativas'));
...
$refCampo 	=  array("refobras","refcooperativas","refdias");
//////////////////////////////////////////////  FIN de los opciones //////////////////////////
